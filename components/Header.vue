<template>
    <header class="w-full">
        <nav class="w-full flex flex-row justify-center text-lg">
            <div class="absolute w-full max-w-4xl p-3 flex md:flex-row flex-col justify-between items-center border-b border-primary">
            <div class="grid grid-cols-6 gap-10 justify-items-center items-center md:hidden">
            ...
            <a ref="nav5" class="my-2 md:my-0 hidden md:block" href=""><ButtonFilled>JOIN US!</ButtonFilled></a>
            </div>
      </nav>
    </header>
</template>
