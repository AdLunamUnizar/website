    ...
    <div class="flex flex-col items-center justify-center p-3 bg-slate-200">
        <div class="max-w-2xl">
            ...
            <div class="flex flex-wrap justify-center">
                ...
                <a href="https://edu.ieee.org/es-unizar/" class="m-2"><img src="/public/images/partners/ieee.png" class="w-auto h-20 m-3" alt="IEEE" /></a>
                <a href="https://www.clipcarbono.com/es/" class="m-2"><img src="/public/images/partners/clip_carbono.jpg" class="w-auto h-20  m-3" alt="Clip carbono" /></a>
